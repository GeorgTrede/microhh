...
subplot(133)
plot(
    time100_3rd[1:100], mass100_3rd[1:100] - mass100_3rd[1], "b-", label="rk3: dt=10.0"
)
plot(
    time100_4th[1:100], mass100_4th[1:100] - mass100_4th[1], "r-", label="rk4: dt=10.0"
)
plot(
    time200_3rd[1:200], mass200_3rd[1:200] - mass200_3rd[1], "b--", label="rk3: dt=5.0"
)
plot(
    time200_4th[1:200], mass200_4th[1:200] - mass200_4th[1], "r--", label="rk4: dt=5.0"
)
...
plot(
    time800_3rd[1:800], mass800_3rd[1:800] - mass800_3rd[1], "b:", label="rk3: dt=1.25"
)
plot(
    time800_4th[1:800], mass800_4th[1:800] - mass800_4th[1], "r:", label="rk4: dt=1.25"
)
legend(loc=0, frameon=False)
