...
for t in range(nt):
    plot(
        yplus[starty:endy],
        (uvart[t, starty:endy] / ustar**2.0) ** 0.5,
        color="#cccccc",
    )
    plot(
        yplus[starty:endy],
        (vvart[t, starty:endy] / ustar**2.0) ** 0.5,
        color="#cccccc",
    )
    plot(
        yplush[starty:endy],
        (wvart[t, starty:endy] / ustar**2.0) ** 0.5,
        color="#cccccc",
    )
plot(yplus[starty:endy], (uvar[starty:endy] / ustar**2.0) ** 0.5, "b-")
plot(yplus[starty:endy], (vvar[starty:endy] / ustar**2.0) ** 0.5, "g-")
plot(yplush[starty:endy], (wvar[starty:endy] / ustar**2.0) ** 0.5, "r-")
