...
strength_co2 = np.round(732.5 / 9.0 / Mco2, decimals=2)  # kmol(CO2) s-1
...
if sw_plume_rise:
    ...
    strength = (
        constant_list(strength_co2, 1)
    )
    sw_vmr = (
        constant_list("true", 1)
    )
    repeat = 1
else:
    source_list = constant_list("co2", 1)
    strength = constant_list(strength_co2, 1)
    sw_vmr = constant_list("true", 1)
    repeat = 1
...
print("sigma_x={}".format(constant_list(sigma_x, repeat * 1)))
print("sigma_y={}".format(constant_list(sigma_y, repeat * 1)))
print("sigma_z={}".format(constant_list(sigma_z, repeat * 1)))

print("strength={}".format(strength))
print("swvmr={}".format(sw_vmr))

print("line_x={}".format(constant_list(0, repeat * 1)))
print("line_y={}".format(constant_list(0, repeat * 1)))
print("line_z={}".format(constant_list(0, repeat * 1)))
