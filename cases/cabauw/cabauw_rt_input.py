...
if __name__ == "__main__":
    ...
    def generate_case(
        ...
        homogenize_sw=False,
        homogenize_lw=False,
        homogenize_hr_sw=False,
        homogenize_hr_lw=False,
        spppsqp=256,
    ):
        ...
        copy(
            "{}/misc/van_genuchten_parameters.nc".format(microhh_path),
            "van_genuchten_parameters.nc",
        )

        if gpt_set == "256_224":
            copy(
                "{}/rte-rrtmgp-cpp/rrtmgp-data/rrtmgp-gas-lw-g256.nc".format(
                    microhh_path
                ),
                "coefficients_lw.nc",
            )
            copy(
                "{}/rte-rrtmgp-cpp/rrtmgp-data/rrtmgp-gas-sw-g224.nc".format(
                    microhh_path
                ),
                "coefficients_sw.nc",
            )
            ...
            copy(
                "{}/rte-rrtmgp-cpp/rrtmgp-data/rrtmgp-gas-lw-g128.nc".format(
                    microhh_path
                ),
                "coefficients_lw.nc",
            )
            copy(
                "{}/rte-rrtmgp-cpp/rrtmgp-data/rrtmgp-gas-sw-g112.nc".format(
                    microhh_path
                ),
                "coefficients_sw.nc",
            )
        ...
        copy(
            "{}/rte-rrtmgp-cpp/rrtmgp-data/rrtmgp-clouds-lw.nc".format(microhh_path),
            "cloud_coefficients_lw.nc",
        )
        copy(
            "{}/rte-rrtmgp-cpp/rrtmgp-data/rrtmgp-clouds-sw.nc".format(microhh_path),
