...
os.symlink(
    "{}/rte-rrtmgp-cpp/rrtmgp-data/rrtmgp-gas-lw-g128.nc".format(microhh_root),
    "coefficients_lw.nc",
)
os.symlink(
    "{}/rte-rrtmgp-cpp/rrtmgp-data/rrtmgp-gas-sw-g112.nc".format(microhh_root),
    "coefficients_sw.nc",
)

os.symlink(
    "{}/rte-rrtmgp-cpp/rrtmgp-data/rrtmgp-clouds-lw.nc".format(microhh_root),
    "cloud_coefficients_lw.nc",
)
os.symlink(
    "{}/rte-rrtmgp-cpp/rrtmgp-data/rrtmgp-clouds-sw.nc".format(microhh_root),
