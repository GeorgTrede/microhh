...
ypluslin = np.arange(0.5, 15.0, 0.1)
ypluslog = np.arange(5.0, 800.0, 1.0)
ulin = ypluslin
ulog = 2.5 * np.log(ypluslog) + 5.0
...
plot(yplus[starty:endy], u2_resid[starty:endy] * visc / ustar**4.0, "k-", label="resid")
...
plot(yplus[starty:endy], v2_resid[starty:endy] * visc / ustar**4.0, "k-", label="resid")
...
plot(yplus[starty:endy], uw_shear[starty:endy] * visc / ustar**4.0, "b-", label="S")
plot(yplus[starty:endy], uw_turb[starty:endy] * visc / ustar**4.0, "g-", label="Tt")
plot(yplus[starty:endy], uw_visc[starty:endy] * visc / ustar**4.0, "c-", label="Tv")
plot(yplus[starty:endy], uw_diss[starty:endy] * visc / ustar**4.0, "r-", label="D")
plot(yplus[starty:endy], uw_pres[starty:endy] * visc / ustar**4.0, "y-", label="Tp")
plot(yplus[starty:endy], uw_rdstr[starty:endy] * visc / ustar**4.0, "m-", label="P")
plot(yplus[starty:endy], uw_resid[starty:endy] * visc / ustar**4.0, "k-", label="resid")
